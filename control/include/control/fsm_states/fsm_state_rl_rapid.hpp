...
private:
    ...
    hotdog::cpu_mlp::MlpFullyConnected< float, kNumObsRapid + kNumPrivilegedObsRapid, 12, hotdog::cpu_mlp::ActivationType::elu >                  policy_;
    hotdog::cpu_mlp::MlpFullyConnected< float, kNumObsRapid * kNumObsHistoryRapid, kNumPrivilegedObsRapid, hotdog::cpu_mlp::ActivationType::elu > adaptation_;

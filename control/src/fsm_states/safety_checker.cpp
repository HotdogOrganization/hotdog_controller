        ...
        if ( foot_pos_feedback_[ i ].norm() > max_leg_length_for_lift && gait_trans_done_ && rpy_cmd_good_ && omega_cmd_good_
             && ( ( fabs( foot_pos_feedback_front_average_( 2 ) ) > max_foot_pos_for_lift( 2 ) && joint_torque_feedback_front_average_( 2 ) > ( min_joint_torque_for_lift( 2 ) * torque_ratio_ )
                  ...
                  || ( fabs( foot_pos_feedback_average_( 2 ) ) > max_foot_pos_for_lift( 2 ) && joint_torque_feedback_average_( 2 ) > ( min_joint_torque_for_lift( 2 ) * torque_ratio_ ) ) ) ) {
                    if( fabs( foot_pos_feedback_front_average_( 2 ) ) > max_foot_pos_for_lift( 2 ) && joint_torque_feedback_front_average_( 2 ) > ( min_joint_torque_for_lift( 2 ) * torque_ratio_ )
                    && seResult.angular_velocity_in_body_frame( 1 ) < -max_omega_for_lift( 1 ) && !all_leg_needed_ )
                        std::cout << "foot_pos_feedback_00000000" << std::endl;
                    if( fabs( foot_pos_feedback_front_min_( 2 ) ) > max_foot_pos_for_lift( 2 ) + front_delta_ && seResult.angular_velocity_in_body_frame( 1 ) > max_omega_for_lift( 1 )
                        && seResult.rpy( 1 ) > max_rpy_for_lift( 1 ) )
                        std::cout << "foot_pos_feedback_11111111" << std::endl;
                    if( fabs( foot_pos_feedback_rear_average_( 2 ) ) > max_foot_pos_for_lift( 2 ) && joint_torque_feedback_rear_average_( 2 ) > ( min_joint_torque_for_lift( 2 ) * torque_ratio_ )
                    && seResult.angular_velocity_in_body_frame( 1 ) > max_omega_for_lift( 1 ) && !all_leg_needed_ )
                        std::cout << "foot_pos_feedback_22222222" << std::endl;
                    if( fabs( foot_pos_feedback_rear_min_( 2 ) ) > max_foot_pos_for_lift( 2 ) + rear_delta_ && seResult.angular_velocity_in_body_frame( 1 ) < -max_omega_for_lift( 1 )
                    && seResult.rpy( 1 ) < -max_rpy_for_lift( 1 ) )
                        std::cout << "foot_pos_feedback_33333333" << std::endl;
                    if( fabs( foot_pos_feedback_average_( 2 ) ) > max_foot_pos_for_lift( 2 ) && joint_torque_feedback_average_( 2 ) > ( min_joint_torque_for_lift( 2 ) * torque_ratio_ ) )
                        std::cout << "foot_pos_feedback_44444444" << std::endl;


                    std::cout << "..........................foot_pos_feedback_front_average_: " << foot_pos_feedback_front_average_(2) << std::endl;
                    std::cout << "..........................joint_torque_feedback_front_average_: " << joint_torque_feedback_front_average_(2) << std::endl;
                    std::cout << "..........................torque_ratio_: " << torque_ratio_ << std::endl;
                    std::cout << "..........................foot_pos_feedback_front_min_: " << foot_pos_feedback_front_min_(2) << std::endl;
                    std::cout << "..........................front_delta_: " << front_delta_ << std::endl;
                    std::cout << "..........................angular_velocity_in_body_frame: " << seResult.angular_velocity_in_body_frame(1) << std::endl;
                    std::cout << "..........................rpy: " << seResult.rpy(1) << std::endl;
                    std::cout << "..........................foot_pos_feedback_rear_average_: " << foot_pos_feedback_rear_average_(2) << std::endl;
                    std::cout << "..........................joint_torque_feedback_rear_average_: " << joint_torque_feedback_rear_average_(2) << std::endl;
                    std::cout << "..........................rear_delta_: " << rear_delta_ << std::endl;
                    std::cout << "..........................foot_pos_feedback_average_: " << foot_pos_feedback_average_(2) << std::endl;
                    std::cout << "..........................max_foot_pos_for_lift: " << max_foot_pos_for_lift(2) << std::endl;
                    std::cout << "..........................joint_torque_feedback_average_: " << joint_torque_feedback_average_(2) << std::endl;

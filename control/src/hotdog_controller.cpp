...
HotdogController::HotdogController() : RobotController() {
    motor_error_ = false;
    motor_warn_  = false;
...
void HotdogController::HandleLegErrorAndWarn( int32_t flags[ 12 ] ) {
    // resolve error code
...
int HotdogController::GetLegMode( int32_t flags[ 12 ] ) {
    int32_t mode[ 12 ];
 ...
 *
 */
void HotdogController::RunController() {

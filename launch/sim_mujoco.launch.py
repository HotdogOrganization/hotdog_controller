...
def launch_setup(context, *args, **kwargs):
    ...
    robot_controllers = os.path.join(
        get_package_share_directory("hotdog_controller"),  # 修改为tita_controller
        "config",
    ...
    mujoco_simulate_app = Node(
        ...
        parameters=[
            ...
            {"robot_description": robot_description},  # 添加robot_description
            {"sim_mode" : True},
            robot_controllers
        ],
        output='screen')

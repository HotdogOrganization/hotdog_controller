...
public:
    explicit SimulationBridge( RobotType robot, RobotController* robot_ctrl )
        : robot_( robot ), lcm_( "udpm://239.255.76.67:7671?ttl=255" ), hotdog_lcm_( "udpm://239.255.76.67:7671?ttl=255" ), motion_list_lcm_( "udpm://239.255.76.67:7671?ttl=255" ),
        ...
        hotdog_lcm_.subscribe( LCM_CMD_CHANNEL_NAME, &SimulationBridge::HotdogLcmCmdCallback, this );
...
private:
    ...
    std::thread          interface_lcm_thread_hotdog_cmd_;
    ...
    void                 HandleInterfaceLCM_hotdog_cmd();

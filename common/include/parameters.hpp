...
#define SPI_YAML_SH_PATH "/robot-software/common/config/hotdog-spi.yaml"
#define SPI_YAML_HAND_SH_PATH "/robot-software/common/config/hotdog-spi-hand.yaml"
#define SPI_YAML_HAND_SH_BAK_PATH "/robot-software/common/config/hotdog-spi-hand.yaml.bak"

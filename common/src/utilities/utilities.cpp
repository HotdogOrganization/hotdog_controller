...
/**
 * @brief Get the Preinstalled Motion Path For HotDog object
 *
 * @return std::string
 */
std::string GetPreinstalledMotionPathForHotDog() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog/preinstalled/";
}

/**
 * @brief Get the Preinstalled Motion Path For HotDog2 object
 *
 * @return std::string
 */
std::string GetPreinstalledMotionPathForHotDog2() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog2/preinstalled/";
}
...
std::string GetUserGaitDefinePath() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog2/user/define/";
}
...
std::string GetUserGaitParameterPath() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog2/user/parameter/";
}
...
std::string GetNonperiodicGaitDefinePath() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog2/nonperiodic/define/";
}
...
std::string GetNonperiodicGaitParameterPath() {
    return std::string( THIS_COM ) + "control/motion_list/hotdog2/nonperiodic/parameter/";
}

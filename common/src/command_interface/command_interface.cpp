 ...
 * @param robotType robot type, hotdog or hotdog2
 */
void CommandInterface::PrepareCmd( int use_rc, long int* control_mode, long int* gait_id, const RobotType& robotType ) {
    ...
    if ( cmd_list_.size() > 0 ) {
        ...
        if ( interface_iter_ >= command_.duration && command_.duration != 0 ) {
            ...
            if ( cmd_list_.size() == 0 ) {
                if ( command_.cmd_source == kHotdogLcmCmd || command_.cmd_source == kHotdog2LcmCmd )
        ...
        if ( command_.mode == MotionMode::kMotion ) {
            if ( motion_trigger_ == 0 && command_.cmd_source != kHotdogLcmCmd ) {
                while ( !cmd_list_.empty() )
                    cmd_list_.pop();
                ...
                if ( robotType == RobotType::CYBERDOG2 ) {
                    ...
                    case MotionId::kMotionAllInOne:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_motion.toml" );
                        break;
                    case MotionId::kHiFiveLeft:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_hiFive_LFleg_posCtrl.toml" );
                        break;
                    case MotionId::kHiFiveRight:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_hiFive_RFleg_posCtrl.toml" );
                        break;
                    case MotionId::kSitDown:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_sitDown_posCtrl.toml" );
                        break;
                    case MotionId::kSwingHip:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_swing_hip_posCtrl.toml" );
                        break;
                    case MotionId::kSwingHead:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_swing_head_posCtrl.toml" );
                        break;
                    case MotionId::kStretchBody:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_bodystretch.toml" );
                        break;
                    case MotionId::kSitDownLeft:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_sitDown_posCtrl_left.toml" );
                        break;
                    case MotionId::kSitDownRight:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_sitDown_posCtrl_right.toml" );
                        break;
                    case MotionId::kSitDownShake:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_sitDown_posCtrl_shake.toml" );
                        break;
                    case MotionId::kMotionBallet:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_ballet.toml" );
                        break;
                    case MotionId::kMotionMoonwalk:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_moonwalk.toml" );
                        break;
                    case MotionId::kMotionFrontLift:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_front_lift_out_in.toml" );
                        break;
                    case MotionId::kMotionRearLift:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_rear_lift_out_in.toml" );
                        break;
                    case MotionId::kMotionPitchLeft:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_pitch_down_left.toml" );
                        break;
                    case MotionId::kMotionPitchRight:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_pitch_down_right.toml" );
                        break;
                    case MotionId::kMotionDiagonalRight:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_diagonal_right.toml" );
                        break;
                    case MotionId::kMotionDiagonalLeft:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_diagonal_left.toml" );
                        break;
                    case MotionId::kMotionWalkWave:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_walk_wave.toml" );
                        break;
                    case MotionId::kMotionTrotInOut:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_trot_in_out.toml" );
                        break;
                    case MotionId::kMotionTrotPitch:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_trot_pitch.toml" );
                        break;
                    case MotionId::kMotionFrontLiftForward:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_front_lift_left_right.toml" );
                        break;
                    case MotionId::kMotionRearLiftForward:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_rear_lift_left_right.toml" );
                        break;
                    case MotionId::kMotionFrontSwitch:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_front_lift_switch.toml" );
                        break;
                    case MotionId::kMotionRearSwitch:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_rear_lift_switch.toml" );
                        break;
                    case MotionId::kMotionJump3d:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_jump3D.toml" );
                        break;
                    case MotionId::kMotionTrotSwing:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_trot_swing.toml" );
                        break;
                    case MotionId::kMotionSpecialPronk:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_special_pronk.toml" );
                        break;
                    case MotionId::kMotionSpecialTrot:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_special_trot.toml" );
                        break;
                    case MotionId::kMotionMoonwalkLeft:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_moonwalk_switch_left.toml" );
                        break;
                    case MotionId::kMotionMoonwalkRight:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_moonwalk_switch_right.toml" );
                        break;
                    case MotionId::kMotionMoonwalkBack:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_moonwalk_backward.toml" );
                        break;
                    case MotionId::kMotionUpDown:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_up_down.toml" );
                        break;
                    case MotionId::kMotionPushUp:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_push_up.toml" );
                        break;
                    case MotionId::kMotionPitchGainCalibration:
                        if ( MotionListCppTomlRead( "/mnt/misc/hotdog2_pitch_gain_factory_calibrate.toml" ) < 0 )
                            MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_pitch_gain_factory_calibrate.toml" );
                        break;
                    case MotionId::kMotionUser00:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user80_ballet.toml" );
                        break;
                    case MotionId::kMotionUser01:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user81_front_lift.toml" );
                        break;
                    case MotionId::kMotionUser02:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user82_rear_lift.toml" );
                        break;
                    case MotionId::kMotionUser03:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user83_walk_wave.toml" );
                        break;
                    case MotionId::kMotionUser04:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user84_trot_in_out.toml" );
                        break;
                    case MotionId::kMotionUser05:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user85_diagonal_FR.toml" );
                        break;
                    case MotionId::kMotionUser06:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user86_diagonal_FL.toml" );
                        break;
                    case MotionId::kMotionUser07:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user87_pronk_front_back.toml" );
                        break;
                    case MotionId::kMotionUser08:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user88_FR_lift.toml" );
                        break;
                    case MotionId::kMotionUser09:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user89_FL_lift.toml" );
                        break;
                    case MotionId::kMotionUser10:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user90_moonwalk.toml" );
                        break;
                    case MotionId::kMotionUser11:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user91_amble.toml" );
                        break;
                    case MotionId::kMotionUser16:
                        MotionListCppTomlRead( GetUserGaitParameterPath() + "hotdog2_user96_moonwalk_backward.toml" );
                        break;
                    case MotionId::kMotionUserGait:
                        MotionListFullCppTomlRead( user_gait_list_file_ );
                        break;
                    case MotionId::kDanceSet1:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_short_dance_1.toml" );
                        break;
                    case MotionId::kDanceSet2:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_short_dance_2.toml" );
                        break;
                    default:
                        MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog2() + "hotdog2_motion.toml" );
                        break;
                    ...
                    MotionListCppTomlRead( GetPreinstalledMotionPathForHotDog() + "toml/motion.toml" );
                motion_trigger_ = command_.gait_id != 0 ? command_.gait_id : 1;
                interface_iter_ = 0;
                command_        = cmd_list_.front();
            }
            else if ( motion_trigger_ == 0 && command_.cmd_source == kHotdogLcmCmd ) {
                cmd_list_.pop();
                command_ = pose_empty_cmd_;
                cmd_list_.push( command_ );
                interface_iter_ = 0;
...
void CommandInterface::Gamepad2Cmd( long int* control_mode, long int* gait_id, const RobotType& robotType )
{
    ...
    if ( cmd_cur_.mode == MotionMode::kQpStand ) {  // QP stand
        ...
        cmd_cur_.pos_des[ 2 ]     = ( ( robotType == RobotType::CYBERDOG2 ) ? 0.32 : 0.32 );
...
void CommandInterface::Keyboard2Cmd(long int* control_mode, long int* gait_id, const RobotType& robotType)
{
    ...
    if (cmd_cur_.mode == MotionMode::kQpStand && (std::fabs(keyboard_cmd_.xVel) > 0.01 || std::fabs(keyboard_cmd_.yVel) > 0.01 || std::fabs(keyboard_cmd_.yawVel) > 0.01)) {
...
void CommandInterface::Rc2Cmd(long int* control_mode, long int* gait_id, const RobotType& robotType)
{
    ...
    if ( cmd_cur_.mode == MotionMode::kQpStand ) {  // QP stand
        ...
        cmd_cur_.vel_des[ 1 ] = 0;
        cmd_cur_.vel_des[ 2 ] = 0;
        cmd_cur_.rpy_des[ 0 ] = rc_cmd_.leftStickAnalog[ 0 ] * 0.3;   // roll
        cmd_cur_.rpy_des[ 1 ] = rc_cmd_.leftStickAnalog[ 1 ] * 0.3;   // pitch
        cmd_cur_.rpy_des[ 2 ] = rc_cmd_.rightStickAnalog[ 0 ] * 0.3;  // yaw
        if ( cmd_cur_.gait_id == 1 || cmd_cur_.gait_id == 3 )
            cmd_cur_.pos_des[ 2 ] = - 0.1 * rc_cmd_.rightStickAnalog[ 1 ];
        else
            cmd_cur_.pos_des[ 2 ] = ( ( robotType == RobotType::CYBERDOG2 ) ? 0.32 : 0.32 ) + 0.1 * rc_cmd_.rightStickAnalog[ 1 ];
        cmd_cur_.contact = 0x0F;
    }
    else if ( cmd_cur_.mode == MotionMode::kLocomotion || cmd_cur_.mode == MotionMode::kRlRapid ) {
        // x,y, yaw velocity command
        cmd_cur_.vel_des[ 0 ]     = rc_cmd_.leftStickAnalog[ 1 ] * 0.5;
        cmd_cur_.vel_des[ 1 ]     = - rc_cmd_.leftStickAnalog[ 0 ] * 0.5;
        cmd_cur_.vel_des[ 2 ]     = - rc_cmd_.rightStickAnalog[ 0 ] * 0.5;
        cmd_cur_.rpy_des[ 0 ]     = 0;
        cmd_cur_.rpy_des[ 2 ]     = 0;
